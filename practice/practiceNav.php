<div class=" navbar fixed-top  " style="font-size: small;background-color:cyan">
       <form id="queform" action="./api/loadquestion.php" method="post" class="m-auto" >
            ...
            <input type="radio" name="by" value="bynum" id="bynum" checked>依題目編號<input class="input" type="number" name="min" value="1">題 到第<input class="input" type="number" name="max" value="100">題 (1~1365) <br>
